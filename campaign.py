...
from levels.Level_15 import level15_dialogue
...
def start_campaign(player_state):
    ...
    run_level(level1, "Level 1", player_state)

    terminal_screen_clear()
    run_level(level2, "Level 2", player_state)

    terminal_screen_clear()
    run_level(level3, "Level 3", player_state)

    terminal_screen_clear()
    run_level(level4, "Level 4", player_state)

    terminal_screen_clear()
    run_level(level5, "Level 5", player_state)

    terminal_screen_clear()
    run_level(level6, "Level 6", player_state)

    terminal_screen_clear()
    run_level(level7, "Level 7", player_state)

    terminal_screen_clear()
    run_level(level8, "Level 8", player_state)

    terminal_screen_clear()
    run_level(level9, "Level 9", player_state)

    terminal_screen_clear()
    run_level(level10, "Level 10", player_state)

    terminal_screen_clear()
    run_level(level11, "Level 11", player_state)

    terminal_screen_clear()
    run_level(level12, "Level 12", player_state)

    terminal_screen_clear()
    run_level(level13, "Level 13", player_state)

    terminal_screen_clear()
    run_level(level14, "Level 14", player_state)
